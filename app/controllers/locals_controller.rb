class LocalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @local.save
        format.html { redirect_to @local, notice: 'Local ha sido creado satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @local.update_attributes(params[:local])
        format.html { redirect_to @local, notice: 'Local ha sido modificado satisfactoriamente.' }
